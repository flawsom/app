-- Project UNIFY Database Schema Migration
...
CREATE INDEX IF NOT EXISTS idx_applications_mentor_approval ON applications(mentor_approval_status);
...
CREATE INDEX IF NOT EXISTS idx_student_profiles_search ON student_profiles USING gin(to_tsvector('english', first_name || ' ' || last_name || ' ' || COALESCE(bio, '')));
